...
const Private = () => {
    return (
        <StDiv private_box>
            <StH2>개인정보처리방침</StH2>
            주식회사 Photo-Pie(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에
            따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고
            원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보
            처리지침을 수립․공개합니다.
            <div>
                <StP PrivateTitle>제1조 (개인정보의 처리목적)</StP>
                ...
                미만 아동의 개인정보처리시 법정대리인의 동의여부 확인, 각종
                ...
                <br />
                <StP PrivateTitle>제2조 (개인정보의 처리 및 보유기간)</StP>
                <div>
                ...
                <StDiv txt>
                    ...
                    표시․광고에 관한 기록 : 6월 - 계약 또는 청약철회, 대금결제,
                    재화 등의 공급기록 : 5년 - 소비자 불만 또는 분쟁처리에 관한
                    기록 : 3년
                    <br />
                    (2) 「통신비밀보호법」제41조에 따른 통신사실확인자료 보관 -
                    가입자 전기통신일시, 개시․종료시간, 상대방 가입자번호,
                    사용도수, 발신기지국 위치추적자료 : 1년 - 컴퓨터통신, 인터넷
                    로그기록자료, 접속지 추적자료 : 3개월
                </StDiv>
                <StP PrivateTitle>제3조 (개인정보의 제3자 제공)</StP>
                ① 회사는 정보주체의 개인정보를 제1조(개인정보의 처리목적)에서
                명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한
                규정 등 개인정보 보호법 제17조에 해당하는 경우에만 개인정보를
                제3자에게 제공합니다. <br />② 회사는 다음과 같이 개인정보를
                제3자에게 제공하고 있습니다. - 개인정보를 제공받는 자 : 예- (주)
                OOO 카드 - 제공받는 자의 개인정보 이용목적 : 예- 이벤트 공동개최
                등 업무제휴 및 제휴 신용카드 발급 - 제공하는 개인정보 항목 : 예-
                성명, 주소, 전화번호, 이메일주소, 카드결제계좌정보 - 제공받는
                자의 보유․이용기간 : 예- 신용카드 발급계약에 따른 거래기간동안
                <br />
                <StP PrivateTitle>제4조(개인정보처리의 위탁)</StP>
                ① 회사는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보
                처리업무를 위탁하고 있습니다. <br />
                1. 전화 상담센터 운영 - 위탁받는 자 (수탁자) : OOO CS센터 -
                위탁하는 업무의 내용 : 전화상담 응대, 부서 및 직원 안내 등
                <br />
                2. A/S 센터 운영 - 위탁받는 자 (수탁자) : OOO 전자 - 위탁하는
                업무의 내용 : 고객 대상 제품 A/S 제공
                <br />② 회사는 위탁계약 체결시 개인정보 보호법 제25조에 따라
                위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치,
                재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한
                사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게
                처리하는지를 감독하고 있습니다. <br />③ 위탁업무의 내용이나
                ...
                지체없이 조치하겠습니다. <br />③ 정보주체가 개인정보의 오류 등에
                ...
                제출하셔야 합니다. <br />⑤ 정보주체는 개인정보 보호법 등
                관계법령을 위반하여 회사가 처리하고 있는 정보주체 본인이나
                타인의 개인정보 및 사생활을 침해하여서는 아니됩니다.
                <br />
                <StP PrivateTitle>제6조(처리하는 개인정보 항목)</StP>
                회사는 다음의 개인정보 항목을 처리하고 있습니다.
                <StDiv txt>
                    1. 홈페이지 회원 가입 및 관리 필수항목 : 예- 성명, 생년월일,
                    아이디, 비밀번호, 주소, 전화번호, 성별, 이메일주소,
                    아이핀번호 선택항목 : 예- 결혼여부, 관심분야 <br />
                    2. 재화 또는 서비스 제공 필수항목 : 예- 성명, 생년월일,
                    아이디, 비밀번호, 주소, 전화번호, 이메일주소, 아이핀번호,
                    신용카드번호, 은행계좌정보 등 결제정보 선택항목 : 관심분야,
                    과거 구매내역
                    <br />
                ...
                <StP PrivateTitle>제7조(개인정보의 파기)</StP>
                ...
                <StP PrivateTitle>제8조(개인정보의 안전성 확보조치)</StP>
                ...
                <StP PrivateTitle>제10조(개인정보 보호책임자)</StP>① 회사는
                개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와
                관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이
                개인정보 보호책임자를 지정하고 있습니다.
                <StDiv txt>
                    ▶ 개인정보 보호책임자 성명 : OOO 직책 : OOO 연락처 :
                    전화번호, 이메일, 팩스번호 ※ 개인정보 보호 담당부서로
                    연결됩니다. <br />▶ 개인정보 보호 담당부서 부서명 : OOO 팀
                    담당자 : OOO 연락처 : 전화번호, 이메일, 팩스번호 ②
                ...
                <StP PrivateTitle>제11조(개인정보 열람청구)</StP>
                정보주체는 개인정보 보호법 제35조에 따른 개인정보의 열람 청구를
                아래의 부서에 할 수 있습니다. 회사는 정보주체의 개인정보
                열람청구가 신속하게 처리되도록 노력하겠습니다. <br />
                <StDiv txt>
                    ▶ 개인정보 열람청구 접수․처리 부서 부서명 : OOO 담당자 : OOO
                    연락처 : 전화번호, 이메일, 팩스번호
                </StDiv>
                <StP PrivateTitle>제12조(권익침해 구제방법)</StP>
                정보주체는 아래의 기관에 대해 개인정보 침해에 대한 피해구제,
                상담 등을 문의하실 수 있습니다. <br />
                <StDiv txt>
                    ▶ 개인정보 침해신고센터 (한국인터넷진흥원 운영) - 소관업무 :
                    개인정보 침해사실 신고, 상담 신청 - 홈페이지 :
                    privacy.kisa.or.kr - 전화 : (국번없이) 118 - 주소 : (58324)
                    전남 나주시 진흥길 9(빛가람동 301-2) 3층
                    개인정보침해신고센터
                    <br />▶ 개인정보 분쟁조정위원회 - 소관업무 : 개인정보
                ...
                <StP PrivateTitle>제13조(개인정보 처리방침 시행 및 변경)</StP>이
                개인정보 처리방침은 "사이트 개설일" 부터 적용됩니다.
            </div>
        </StDiv>
    );
};
